...
public class ImageGenerator {
    ...
    static {
        ...
        colorMap.put(Color.Colors.BRIGHT_WHITE, new java.awt.Color(255, 255, 255)); // Bright White
        ...
        colorMap.put(Color.Colors.BACK_RED, new java.awt.Color(0, 255, 255)); // Bright Cyan
        colorMap.put(Color.Colors.BACK_GREEN, new java.awt.Color(255, 255, 255)); // Bright White
    }
